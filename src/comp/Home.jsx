...
export default function Home() {
  return (
    <div className=''>
      <div className='bg  '>
      <div className='max-w-md p-6 w-full md:w-[35%] h-auto md:h-[80vh] rounded relative text-center'>
  <h1 className='text-[#1eff00] font-bold text-2xl md:text-4xl lg:text-5xl mt-6 font-serif'>
    SonyrottiesHome
  </h1>
  ...
  <button className='text-white bg-[#1eff00] rounded-md py-2 px-4 mt-6 mb-6'>
    Available Puppies
  </button>
</div>
