...
export default function Home() {
  return (
    <div className=''>
      <div className='bg  '>
        <div className=' max-w-md  p-6  w-[35%]  h-[80vh] rounded relative text-center  '>
          <h1 className='text-[#1eff00] absolute font-bold text- md:text-4xl lg:text-5xl mt-6 font-serif sm:text-[25px]'>
            SonyrottiesHome
          </h1>
          <p className='text-white text-base md:text-lg lg:text-[15px] absolute mt-[90px] text-center sm: text-[12px]'>
          ...
          <div className=' sm:mt-[120px] '>
            <button className='text-white  bg-[#1eff00] rounded-md py-2 px-4 mt-[500px] sm:  '>
              Available Puppies
            </button>
          </div>
        </div>
